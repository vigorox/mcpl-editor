...
async function createWindow() {
  ...
  const win = new BrowserWindow({
    ...
    height: 768,
    minWidth: 800,
    minHeight: isDevelopment ? 300 : 600,
    webPreferences: {
      ...
      // devTools: false, // disable devtools but register hot key to toggle it
  ...
  win.menuBarVisible = false; // hide menu bar

  // // Ask user to confirm before closing the window
  ...
  globalShortcut.register('CmdOrCtrl+Alt+F12', () => {
